...
// #12 — couleur de fond par mode + nom officiel Kord Breach
const MODES = [
  {
    key: 'regular',
    label: 'PVP',
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-tarkov-bg text-tarkov-text">
      {/* Header — couleur change selon le mode actif (#12) */}
      <header className={`bg-gradient-to-r ${activeMeta.headerBg} border-b ${activeMeta.borderColor} px-6 py-4 transition-all duration-500`}>
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            {/* Sélecteur de mode */}
            <div className="flex items-center gap-1 bg-black/30 border border-white/10 rounded px-1 py-1">
              {MODES.map((m) => (
