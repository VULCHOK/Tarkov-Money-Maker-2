...
// Image hideout Wikipedia pour l'IntelCard
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{ width: 72 }}>
        <img
          ...
          onError={(e) => {
            if (e.target.src !== meta.fallback) e.target.src = meta.fallback;
...
// ─── IntelCard ────────────────────────────────────────────────────────────────
// Image hideout en fond (16:9 recadrée 72x96), boutons niveau comme traders
// ─────────────────────────────────────────────────────────────────────────────
    ...
    >
      ...
      <div className="relative flex-shrink-0" style={{ width: 72 }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent px-1 pt-3 pb-0.5">
          ...
          {discount > 0 && (
            <span className="text-[9px] text-green-400 font-bold leading-none block">-{discount}% flea</span>
          )}
        </div>
      </div>
  ...
  return (
    <div className="bg-tarkov-card border border-tarkov-border rounded-lg px-4 py-3 mb-6">
      <div className="flex flex-wrap items-center gap-4">
        ...
        {/* Profit minimum — inline dans le bandeau */}
